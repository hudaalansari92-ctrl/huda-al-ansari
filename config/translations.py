...
UI_TEXT = {
    'ar': {
        ...
        'attempt_counter': '⚠️ محاولة {n}/{max} — متبقّي {remaining} {tries_label} قبل الانتقال للسؤال التالي.',
    ...
    'en': {
        ...
        'attempt_counter': '⚠️ Attempt {n}/{max} — {remaining} {tries_label} left before we move on to the next question.',
